...
export default function GoBackIcon({ goTo, ...rest }: GoBackIconProps) {
	return (
		<svg onClick={() => redirect(goTo)} width={25} height={25} color="currentcolor" strokeLinejoin="round" data-testid="geist-icon" viewBox="0 0 16 16"
